...
SECURITY_RISK_DESC = "The LLM's assessment of the safety risk of this action. See the SECURITY_RISK_LEVELS section in the system prompt for risk level definitions."
