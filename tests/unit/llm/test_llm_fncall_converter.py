...
def test_convert_tools_to_description():
    ...
    assert '---- BEGIN FUNCTION #1: execute_bash ----' in formatted_tools
    assert '---- BEGIN FUNCTION #2: finish ----' in formatted_tools
    assert '---- BEGIN FUNCTION #3: apply_patch ----' in formatted_tools
